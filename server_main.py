...
def parse_args():
    ...
    parser.add_arguement('--self_play', action="store_true" , help='option for selfplay')
    parser.add_arguement('--evaluate_model', action="store_true" , help='option for evaluating two model')
