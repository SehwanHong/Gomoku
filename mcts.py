...
class MCTS(Player):
    ...
    def search(self, initialState, needDetails=False):
        ...
        if needDetails:
            return {"action": action, "expectedReward": initialState.getCurrentPlayer() * bestChild.totalReward / bestChild.numVisits}
        else:
            return action
    ...
    def expand(self, node):
        ...
        for action in actions:
            if action not in node.children or random.random() < self.epsilon:
